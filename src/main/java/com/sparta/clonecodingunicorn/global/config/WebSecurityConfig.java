...
import com.sparta.clonecodingunicorn.global.jwt.JwtAuthenticationFilter;
import com.sparta.clonecodingunicorn.global.jwt.JwtAuthorizationFilter;
import com.sparta.clonecodingunicorn.global.jwt.JwtUtil;
import com.sparta.clonecodingunicorn.global.security.MemberDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) ->
                authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/member/**").permitAll() // '/api/member/'로 시작하는 요청 모두 접근 허가
